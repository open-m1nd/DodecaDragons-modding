...
function buyCyanSigilUpgrade(x) {
  ...
  if (x==1 && game.cyanSigilPower.gte(game.cyanSigilUpgradeCost[0])) {
    if (game.cyanSigilPower.lt("e1e10")) game.cyanSigilPower = Decimal.max(game.cyanSigilPower.sub(game.cyanSigilUpgradeCost[0]), 0)
    game.cyanSigilUpgradesBought[0] = game.cyanSigilUpgradesBought[0].add(1)
    game.cyanSigilUpgradeCost[0] = new Decimal(1.5).pow(game.cyanSigilUpgradesBought[0]).floor()
  ...
  else if (x==2 && game.cyanSigilPower.gte(game.cyanSigilUpgradeCost[1])) {
    if (game.cyanSigilPower.lt("e1e10")) game.cyanSigilPower = Decimal.max(game.cyanSigilPower.sub(game.cyanSigilUpgradeCost[1]), 0)
    game.cyanSigilUpgradesBought[1] = game.cyanSigilUpgradesBought[1].add(1)
    game.cyanSigilUpgradeCost[1] = new Decimal(1.5).pow(game.cyanSigilUpgradesBought[1]).mul(20).floor()
  ...
  else if (x==3 && game.cyanSigilPower.gte(game.cyanSigilUpgradeCost[2])) {
    if (game.cyanSigilPower.lt("e1e10")) game.cyanSigilPower = Decimal.max(game.cyanSigilPower.sub(game.cyanSigilUpgradeCost[2]), 0)
    game.cyanSigilUpgradesBought[2] = game.cyanSigilUpgradesBought[2].add(1)
    game.cyanSigilUpgradeCost[2] = new Decimal(2).pow(game.cyanSigilUpgradesBought[2]).mul(500).round()
