...
function magicReset(triggerLayer = "magic") {
  ...
  /*game.fireUpgrade1Bought = new Decimal(0) all of these are no longer used :) - open
  ...
  game.fireUpgradeBought = [new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
  game.fireUpgradeCost = [new Decimal(50), new Decimal(100), new Decimal(100), new Decimal(500), new Decimal(500), new Decimal(2e7)],
...
function buyMagicUpgrade(x) {
  ...
  if (game.magicUpgradesBought[x-1] != true && game.magic.gte(magicUpgradeCosts[x-1])) {
    ...
    if (x==14) document.getElementById("fireUpgrade1Effect").textContent = format(new Decimal(3.5).pow(game.fireUpgradeBought[0].pow(0.7)), 2)
