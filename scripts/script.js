...
// TODO: cyan, blue, violet, pink, red, orange, yellow sigil costs must become arrays and all references to their costs as variables must be replaced
// done so far: cyan
function reset() {
	game = {
    ...
    unlocks: 0,
    lastMajorChangeVersion: 4, //tracks what version was last played so adjustments can be made in the loading code when necessary. 
    lastUpdate: Date.now(),
    lastSave: 0,
    ...
    // ahh... much nicer... isnt it? - open
    
    fireUpgradeBought: [new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
    fireUpgradeCost: [new Decimal(50), new Decimal(100), new Decimal(100), new Decimal(500), new Decimal(500), new Decimal(2e7)],
    dragonStage: 1,
    ...
    cyanSigilUpgradeCost: [new Decimal(1), new Decimal(20), new Decimal(500)],
    ...
    blueSigilUpgradeCost: [new Decimal(1), new Decimal(20), new Decimal(100)],
    ...
    indigoSigilUpgradeCost: [new Decimal(1), new Decimal(20), new Decimal(400)],
    ...
    violetSigilUpgradeCost: [new Decimal(0), new Decimal(5)],
    ...
    pinkSigilUpgradeCost: [new Decimal(1), new Decimal(150000)],
    ...
    redSigilUpgradeCost: [new Decimal(1), new Decimal(1500), new Decimal(50000)],
    ...
    orangeSigilUpgradeCost: [new Decimal(1), new Decimal(2500), new Decimal(250000)],
    ...
    yellowSigilUpgradeCost: [new Decimal(1), new Decimal(4000), new Decimal(2000000)],
    ...
    serpentFragments: new Decimal(0),
    serpentUnlocks: 0,
  }
...
function loadGame(loadgame) {
  ...
  if (game.unlocks >= 2) {
    ...
    document.getElementById("fireUpgrade1Cost").textContent = format(game.fireUpgradeCost[0], 0)
    document.getElementById("fireUpgrade1Effect").textContent = format(new Decimal(2).pow(game.fireUpgradeBought[0].pow(0.6)), 2)
    document.getElementById("fireUpgrade2Cost").textContent = format(game.fireUpgradeCost[1], 0)
    document.getElementById("fireUpgrade3Cost").textContent = format(game.fireUpgradeCost[2], 0)
    document.getElementById("fireUpgrade4Cost").textContent = format(game.fireUpgradeCost[3], 0)
    document.getElementById("fireUpgrade5Cost").textContent = format(game.fireUpgradeCost[4], 0)
    document.getElementById("fireUpgrade6Cost").textContent = format(game.fireUpgradeCost[5], 0)
    document.getElementById("fireUpgrade6Effect").textContent = format(new Decimal(3).pow(game.fireUpgradeBought[5].pow(0.6)), 2)
  }
  //Platinum stuff
  if (game.unlocks >= 3) {
    document.getElementById("unlockAlchemyButton").style.display = "none"
  ...
  if (game.unlocks >= 10) {
    ...
    document.getElementById("cyanSigilUpgrade1Cost").textContent = format(game.cyanSigilUpgradeCost[0], 0)
    document.getElementById("cyanSigilUpgrade1Effect").textContent = format(game.cyanSigilUpgradesBought[0].add(1), 2)
    document.getElementById("cyanSigilUpgrade2Cost").textContent = format(game.cyanSigilUpgradeCost[1], 0)
    document.getElementById("cyanSigilUpgrade2Effect").textContent = format(game.cyanSigilUpgradesBought[1].add(1).pow(1.5), 2)
    document.getElementById("cyanSigilUpgrade3Cost").textContent = format(game.cyanSigilUpgradeCost[2], 0)
  ...
  if (game.unlocks >= 11) {
    ...
    document.getElementById("blueSigilUpgrade1Cost").textContent = format(game.blueSigilUpgradeCost[0], 0)
    document.getElementById("blueSigilUpgrade1Effect").textContent = format(game.blueSigilUpgradesBought[0].add(1), 2)
    document.getElementById("blueSigilUpgrade2Cost").textContent = format(game.blueSigilUpgradeCost[1], 0)
    ...
    document.getElementById("blueSigilUpgrade3Cost").textContent = format(game.blueSigilUpgradeCost[2], 0)
  ...
  if (game.unlocks >= 12) {
    ...
    document.getElementById("indigoSigilUpgrade1Cost").textContent = format(game.indigoSigilUpgradeCost[0], 0)
    document.getElementById("indigoSigilUpgrade1Effect").textContent = format(game.indigoSigilUpgradesBought[0].add(1), 2)
    document.getElementById("indigoSigilUpgrade2Cost").textContent = format(game.indigoSigilUpgradeCost[1], 0)
    ...
    document.getElementById("indigoSigilUpgrade3Cost").textContent = format(game.indigoSigilUpgradeCost[2], 0)
  ...
  if (game.unlocks >= 13) {
    ...
    document.getElementById("violetSigilUpgrade1Cost").textContent = format(game.violetSigilUpgradeCost[0], 0)
    document.getElementById("violetSigilUpgrade1Effect").textContent = format(game.violetSigilUpgradesBought[0].add(1), 2)
    document.getElementById("violetSigilUpgrade2Cost").textContent = format(game.violetSigilUpgradeCost[1], 0)
  ...
  if (game.unlocks >= 14) {
    ...
    document.getElementById("pinkSigilUpgrade1Cost").textContent = format(game.pinkSigilUpgradeCost[0], 0)
    document.getElementById("pinkSigilUpgrade1Effect").textContent = format(game.pinkSigilUpgradesBought[0].add(1), 2)
    document.getElementById("pinkSigilUpgrade3Cost").textContent = format(game.pinkSigilUpgradeCost[2], 0)
  ...
  if (game.unlocks >= 21) {
    ...
    document.getElementById("redSigilUpgrade1Cost").textContent = format(game.redSigilUpgradeCost[0], 0)
    ...
    document.getElementById("redSigilUpgrade2Cost").textContent = format(game.redSigilUpgradeCost[1], 0)
  ...
  if (game.unlocks >= 22) {
    ...
    document.getElementById("orangeSigilUpgrade1Cost").textContent = format(game.orangeSigilUpgradeCost[0], 0)
    document.getElementById("orangeSigilUpgrade1Effect").textContent = format(game.orangeSigilUpgradesBought[0].add(1), 2)
    document.getElementById("orangeSigilUpgrade2Cost").textContent = format(game.orangeSigilUpgradeCost[1], 0)
    ...
    document.getElementById("orangeSigilUpgrade3Cost").textContent = format(game.orangeSigilUpgradeCost[2], 0)
  ...
  if (game.unlocks >= 23) {
    ...
    document.getElementById("yellowSigilUpgrade1Cost").textContent = format(game.yellowSigilUpgradeCost[0], 0)
    document.getElementById("yellowSigilUpgrade1Effect").textContent = format(game.yellowSigilUpgradesBought[0].add(1), 2)
    document.getElementById("yellowSigilUpgrade2Cost").textContent = format(game.yellowSigilUpgradeCost[1], 0)
    ...
    document.getElementById("yellowSigilUpgrade3Cost").textContent = format(game.yellowSigilUpgradeCost[2], 0)
  ...
  // Serpent Fragment stuff
  /*if (game.unlocks >= 38) {
    document.getElementsByClassName("box")[47].style.display = "block"
    document.getElementsByClassName("resourceRow")[33].style.display ='block'
    document.getElementById('bigFinishButton').style.display = 'block'
  }*/
  //Dragon stage stuff
	document.getElementsByClassName("upgradeDragonButton")[0].style.display = "block"
...
function fixSaveVersion(oldVersion) { 
  ...
  if (oldVersion < 4) { // v1.0.2 the final final update, addressing fire and various other things being variables instead of arrays - open
    if (game.fireUpgrade1Bought) game.fireUpgradeBought = [game.fireUpgrade1Bought, game.fireUpgrade2Bought, game.fireUpgrade3Bought, game.fireUpgrade4Bought, game.fireUpgrade5Bought, game.fireUpgrade6Bought]
    if (game.fireUpgrade1Cost) game.fireUpgradeCost = [game.fireUpgrade1Cost, game.fireUpgrade2Cost, game.fireUpgrade3Cost, game.fireUpgrade4Cost, game.fireUpgrade5Cost, game.fireUpgrade6Cost]
    if (game.cyanSigilUpgrade1Cost) game.cyanSigilUpgradeCost = [game.cyanSigilUpgrade1Cost, game.cyanSigilUpgrade2Cost,game.cyanSigilUpgrade3Cost]
    if (game.blueSigilUpgrade1Cost) game.blueSigilUpgradeCost = [game.blueSigilUpgrade1Cost, game.blueSigilUpgrade2Cost, game.blueSigilUpgrade3Cost]
    if (game.violetSigilUpgrade1Cost) game.violetSigilUpgradeCost = [game.violetSigilUpgrade1Cost, game.violetSigilUpgrade2Cost]
    if (game.pinkSigilUpgrade1Cost) game.pinkSigilUpgradeCost = [game.pinkSigilUpgrade1Cost, game.pinkSigilUpgrade3Cost]
    if (game.redSigilUpgrade1Cost) game.redSigilUpgradeCost = [game.redSigilUpgrade1Cost, game.redSigilUpgrade2Cost, game.redSigilUpgrade3Cost]
    if (game.orangeSigilUpgrade1Cost) game.orangeSigilUpgradeCost = [game.orangeSigilUpgrade1Cost, game.orangeSigilUpgrade2Cost, game.orangeSigilUpgrade3Cost]
    if (game.yellowSigilUpgrade1Cost) game.yellowSigilUpgradeCost = [game.yellowSigilUpgrade1Cost, game.yellowSigilUpgrade2Cost, game.yellowSigilUpgrade3Cost]
    let keysToDelete = ['fireUpgrade1Bought', 'fireUpgrade2Bought', 'fireUpgrade3Bought', 'fireUpgrade4Bought', 'fireUpgrade5Bought', 'fireUpgrade6Bought', 'fireUpgrade1Cost', 'fireUpgrade2Cost', 'fireUpgrade3Cost', 'fireUpgrade4Cost', 'fireUpgrade5Cost', 'fireUpgrade6Cost', 'cyanSigilUpgrade1Cost', 'cyanSigilUpgrade2Cost', 'cyanSigilUpgrade3Cost', 'blueSigilUpgrade1Cost', 'blueSigilUpgrade2Cost', 'blueSigilUpgrade3Cost', 'violetSigilUpgrade1Cost', 'violetSigilUpgrade2Cost', 'pinkSigilUpgrade1Cost', 'pinkSigilUpgrade3Cost', 'redSigilUpgrade1Cost', 'redSigilUpgrade2Cost', 'redSigilUpgrade3Cost', 'orangeSigilUpgrade1Cost', 'orangeSigilUpgrade2Cost', 'orangeSigilUpgrade3Cost', 'yellowSigilUpgrade1Cost', 'yellowSigilUpgrade2Cost', 'yellowSigilUpgrade3Cost', 'indigoSigilUpgrade4Cost', 'blueSigilUpgrade4Cost', 'blueSigilUpgrade5Cost', 'blueSigilUpgrade6Cost', 'cyanSigilUpgrade4Cost', 'cyanSigilUpgrade5Cost', 'cyanSigilUpgrade6Cost']
    for (let i = 0;i < keysToDelete.length;i++) {
      delete(game[keysToDelete[i]])
    }
  }
...
function updateSmall() {
  ...
  if (game.unlocks >= 2) {
    if (game.darkMagicUpgradesBought[5]) {game.goldPerSecond = game.goldPerSecond.mul(new Decimal(5).pow(game.fireUpgradeBought[1].pow(0.8)))}
    else if (game.magicUpgradesBought[8]) {game.goldPerSecond = game.goldPerSecond.mul(new Decimal(1.6).pow(game.fireUpgradeBought[1].pow(0.8)))}
    else {game.goldPerSecond = game.goldPerSecond.mul(new Decimal(1.25).pow(game.fireUpgradeBought[1].pow(0.8)))}
    if (game.platinumUpgradesBought[8] > 0) {game.goldPerSecond = game.goldPerSecond.mul(game.fireUpgradeBought[3].pow(game.miners.pow(0.3)).pow(game.platinumUpgradesBought[8] / 4).add(1))}
    else {game.goldPerSecond = game.goldPerSecond.mul(game.fireUpgradeBought[3].pow(1.5).mul(game.miners).div(50).add(1))}
  }
  ...
  if (game.magicUpgradesBought[8]) {game.goldPerClick = game.fireUpgradeBought[2].pow(12).mul(4).add(1)}
  else {game.goldPerClick = game.fireUpgradeBought[2].pow(2.6).mul(4).add(1)}
  ...
  if (game.voidMagicUpgradesBought[5]) {game.firePerSecond = game.gold}
    ...
    if (game.magicUpgradesBought[13]) {game.firePerSecond = new Decimal(3.5).pow(game.fireUpgradeBought[0].pow(0.7))}
    else {game.firePerSecond = new Decimal(2).pow(game.fireUpgradeBought[0].pow(0.6))}
    if (game.unlocks >= 2) game.firePerSecond = game.firePerSecond.mul(game.fireUpgradeBought[4].pow(1.5).mul(game.gold.add(1).log10()).div(5).add(1))
  ...
  if (game.darkMagicUpgradesBought[5]) {game.fireGoldMultiplier = game.fire.div(10).add(1).log10().mul(2).add(1).mul(new Decimal(5).pow(game.fireUpgradeBought[1].pow(0.8)))}
  else if (game.magicUpgradesBought[8]) {game.fireGoldMultiplier = game.fire.div(10).add(1).log10().mul(2).add(1).mul(new Decimal(1.6).pow(game.fireUpgradeBought[1].pow(0.8)))}
  else {game.fireGoldMultiplier = game.fire.div(10).add(1).log10().mul(2).add(1).mul(new Decimal(1.25).pow(game.fireUpgradeBought[1].pow(0.8)))}
  ...
  if (game.unlocks >= 2) {
    ...
    if (game.fire.gte(game.fireUpgradeCost[0]) && game.fireUpgradeCost[0].lt("e1e9")) {document.getElementsByClassName("fireUpgrade")[0].disabled = false}
    else {document.getElementsByClassName("fireUpgrade")[0].disabled = true}
    if (game.fire.gte(game.fireUpgradeCost[1]) && game.fireUpgradeCost[1].lt("e1e9")) {document.getElementsByClassName("fireUpgrade")[1].disabled = false}
    else {document.getElementsByClassName("fireUpgrade")[1].disabled = true}
    if (game.fire.gte(game.fireUpgradeCost[2]) && game.fireUpgradeCost[2].lt("e1e9")) {document.getElementsByClassName("fireUpgrade")[2].disabled = false}
    else {document.getElementsByClassName("fireUpgrade")[2].disabled = true}
    if (game.fire.gte(game.fireUpgradeCost[3]) && game.fireUpgradeCost[3].lt("e1e9")) {document.getElementsByClassName("fireUpgrade")[3].disabled = false}
    else {document.getElementsByClassName("fireUpgrade")[3].disabled = true}
    if (game.fire.gte(game.fireUpgradeCost[4]) && game.fireUpgradeCost[4].lt("e1e9")) {document.getElementsByClassName("fireUpgrade")[4].disabled = false}
    else {document.getElementsByClassName("fireUpgrade")[4].disabled = true}
    if (game.fire.gte(game.fireUpgradeCost[5]) && game.fireUpgradeCost[5].lt("e1e9")) {document.getElementsByClassName("fireUpgrade")[5].disabled = false}
    else {document.getElementsByClassName("fireUpgrade")[5].disabled = true}
    if (game.darkMagicUpgradesBought[5]) {document.getElementById("fireUpgrade2Effect").textContent = format(new Decimal(5).pow(game.fireUpgradeBought[1].pow(0.8)), 2)}
    else if (game.magicUpgradesBought[8]) {document.getElementById("fireUpgrade2Effect").textContent = format(new Decimal(1.6).pow(game.fireUpgradeBought[1].pow(0.8)), 2)}
    else {document.getElementById("fireUpgrade2Effect").textContent = format(new Decimal(1.25).pow(game.fireUpgradeBought[1].pow(0.8)), 2)}
    if (game.magicUpgradesBought[8]) {document.getElementById("fireUpgrade3Effect").textContent = format(game.fireUpgradeBought[2].pow(12).mul(4).add(1), 2)}
    else {document.getElementById("fireUpgrade3Effect").textContent = format(game.fireUpgradeBought[2].pow(2.6).mul(4).add(1), 2)}
    if (game.platinumUpgradesBought[8] > 0) {document.getElementById("fireUpgrade4Effect").textContent = format(game.fireUpgradeBought[3].pow(game.miners.pow(0.3)).pow(game.platinumUpgradesBought[8] / 4).add(1), 2)}
    else {document.getElementById("fireUpgrade4Effect").textContent = format(game.fireUpgradeBought[3].pow(1.5).mul(game.miners).div(50).add(1), 2)}
    document.getElementById("fireUpgrade5Effect").textContent = format(game.fireUpgradeBought[4].pow(1.5).mul(game.gold.add(1).log10()).div(5).add(1), 2)
  }
  if (game.unlocks >= 3) {
    ...
    game.platinumToGet = game.gold.add(1).log2().mul(new Decimal(3).pow(game.fireUpgradeBought[5].pow(0.6)))
