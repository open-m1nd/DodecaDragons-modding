...
const achievementNames = [
  ...
  ["Hey, it's like the name of the game! :O", "Dodecadamned", "Dodecadimensional", "Dodecalculus", "Dodecadeadly", "Dodecadangerous", "Dodecalculated", "Dodechaotic", "Dodecadivine", "Dodecadestructive", "Dodecades of work", "Dodecomplete"],
	...
	["This is the final achievement row.", "You have come an incredibly long way.", "Your desire for power is unending.", "All who have tried to stop you have failed.", "There mustn't be long to go now.", "How large really is the omniverse?", "You begin to feel the laws of physics break down around you.", "What drives you?", "What is your final goal? Do you ever intend to stop?", "There is only so much of reality to claim.", "When all is said and done...", "Ce n'est pas encore fini"]
]
